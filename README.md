# Rust API client for pdf-generator-api-client
...
Put the package under your project folder in a directory named `pdf-generator-api-client` and add the following to `Cargo.toml` under `[dependencies]`:

```
pdf-generator-api-client = { path = "./pdf-generator-api-client" }
```
