...
pub async fn get_template_library_item(configuration: &configuration::Configuration, public_id: &str) -> Result<models::InlineObject18, Error<GetTemplateLibraryItemError>> {
    // add a prefix to parameters to efficiently prevent name collisions
