...
/// struct for typed errors of method [`convert_html2_pdf`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ConvertHtml2PdfError {
...
/// struct for typed errors of method [`convert_pdf2_image`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ConvertPdf2ImageError {
    Status401(models::InlineObject21),
    Status402(models::InlineObject22),
    Status403(models::InlineObject23),
    Status404(models::InlineObject24),
...
/// struct for typed errors of method [`convert_url2_pdf`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum ConvertUrl2PdfError {
    Status401(models::InlineObject21),
    Status402(models::InlineObject22),
    Status403(models::InlineObject23),
    Status404(models::InlineObject24),
...
pub async fn convert_html2_pdf(configuration: &configuration::Configuration, convert_html2_pdf_request: models::ConvertHtml2PdfRequest) -> Result<models::InlineObject9, Error<ConvertHtml2PdfError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_convert_html2_pdf_request = convert_html2_pdf_request;

    let uri_str = format!("{}/conversion/html2pdf", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_convert_html2_pdf_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ConvertHtml2PdfError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Converts PDF document to images. Provide either a base64 encoded PDF or a public URL to a PDF file.
pub async fn convert_pdf2_image(configuration: &configuration::Configuration, convert_pdf2_image_request: models::ConvertPdf2ImageRequest) -> Result<models::InlineObject10, Error<ConvertPdf2ImageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_convert_pdf2_image_request = convert_pdf2_image_request;

    let uri_str = format!("{}/conversion/pdf2image", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_convert_pdf2_image_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ConvertPdf2ImageError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Converts public URL to PDF
pub async fn convert_url2_pdf(configuration: &configuration::Configuration, convert_url2_pdf_request: models::ConvertUrl2PdfRequest) -> Result<models::InlineObject9, Error<ConvertUrl2PdfError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_convert_url2_pdf_request = convert_url2_pdf_request;

    let uri_str = format!("{}/conversion/url2pdf", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_convert_url2_pdf_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ConvertUrl2PdfError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
