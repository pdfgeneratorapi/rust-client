...
pub enum CopyTemplateError {
    Status401(models::InlineObject21),
    Status402(models::InlineObject22),
    Status403(models::InlineObject23),
    Status404(models::InlineObject24),
    Status422(models::InlineObject25),
    Status429(models::InlineObject26),
    Status500(models::InlineObject27),
...
/// struct for typed errors of method [`get_template_data`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetTemplateDataError {
    Status401(models::InlineObject21),
    Status402(models::InlineObject22),
    Status403(models::InlineObject23),
    Status404(models::InlineObject24),
...
/// struct for typed errors of method [`get_template_schema`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetTemplateSchemaError {
    Status429(models::InlineObject26),
    Status500(models::InlineObject27),
    UnknownValue(serde_json::Value),
}
...
/// struct for typed errors of method [`open_editor`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
/// struct for typed errors of method [`validate_template`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
...
pub async fn copy_template(configuration: &configuration::Configuration, template_id: i32, copy_template_request: Option<models::CopyTemplateRequest>) -> Result<models::InlineObject16, Error<CopyTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
    let p_copy_template_request = copy_template_request;

    let uri_str = format!("{}/templates/{templateId}/copy", configuration.base_path, templateId=p_template_id);
    ...
    req_builder = req_builder.json(&p_copy_template_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CopyTemplateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Creates a new template. If template configuration is not specified in the request body then an empty template is created. Template is placed to the workspace specified in authentication params. Template configuration must be sent in the request body.
pub async fn create_template(configuration: &configuration::Configuration, template_definition_new: models::TemplateDefinitionNew) -> Result<models::InlineObject16, Error<CreateTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_definition_new = template_definition_new;
    ...
    req_builder = req_builder.json(&p_template_definition_new);
...
pub async fn delete_template(configuration: &configuration::Configuration, template_id: i32) -> Result<(), Error<DeleteTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;

    let uri_str = format!("{}/templates/{templateId}", configuration.base_path, templateId=p_template_id);
...
pub async fn get_template(configuration: &configuration::Configuration, template_id: i32) -> Result<models::InlineObject16, Error<GetTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
...
pub async fn get_template_data(configuration: &configuration::Configuration, template_id: i32) -> Result<models::InlineObject2, Error<GetTemplateDataError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;

    let uri_str = format!("{}/templates/{templateId}/data", configuration.base_path, templateId=p_template_id);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetTemplateDataError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns Template JSON Schema which defines the structure of the Template Definition.
pub async fn get_template_schema(configuration: &configuration::Configuration, ) -> Result<serde_json::Value, Error<GetTemplateSchemaError>> {

    let uri_str = format!("{}/templates/schema", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetTemplateSchemaError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns a list of templates available for the authenticated workspace
pub async fn get_templates(configuration: &configuration::Configuration, name: Option<&str>, tags: Option<&str>, access: Option<&str>, page: Option<i32>, per_page: Option<i32>) -> Result<models::InlineObject4, Error<GetTemplatesError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_name = name;
    let p_tags = tags;
    let p_access = access;
    ...
    if let Some(ref param_value) = p_access {
        req_builder = req_builder.query(&[("access", &param_value.to_string())]);
    }
...
pub async fn import_template(configuration: &configuration::Configuration, import_template_request: models::ImportTemplateRequest) -> Result<models::InlineObject16, Error<ImportTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_import_template_request = import_template_request;

    let uri_str = format!("{}/templates/import", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_import_template_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ImportTemplateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn open_editor(configuration: &configuration::Configuration, template_id: i32, open_editor_request: models::OpenEditorRequest) -> Result<models::InlineObject3, Error<OpenEditorError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
    let p_open_editor_request = open_editor_request;

    let uri_str = format!("{}/templates/{templateId}/editor", configuration.base_path, templateId=p_template_id);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_open_editor_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<OpenEditorError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Updates template configuration. The template configuration for pages and layout must be complete as the entire configuration is replaced and not merged.
pub async fn update_template(configuration: &configuration::Configuration, template_id: i32, template_definition_new: models::TemplateDefinitionNew) -> Result<models::InlineObject16, Error<UpdateTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
    let p_template_definition_new = template_definition_new;
...
pub async fn validate_template(configuration: &configuration::Configuration, template_definition_new: models::TemplateDefinitionNew) -> Result<models::InlineObject1, Error<ValidateTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_definition_new = template_definition_new;

    let uri_str = format!("{}/templates/validate", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<ValidateTemplateError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
