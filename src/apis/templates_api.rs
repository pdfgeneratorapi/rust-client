...
pub async fn copy_template(configuration: &configuration::Configuration, template_id: i32, copy_template_request: Option<models::CopyTemplateRequest>) -> Result<models::InlineObject18, Error<CopyTemplateError>> {
...
pub async fn create_template(configuration: &configuration::Configuration, template_definition_new: models::TemplateDefinitionNew) -> Result<models::InlineObject18, Error<CreateTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn get_template(configuration: &configuration::Configuration, template_id: i32) -> Result<models::InlineObject18, Error<GetTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
...
pub async fn import_template(configuration: &configuration::Configuration, import_template_request: models::ImportTemplateRequest) -> Result<models::InlineObject18, Error<ImportTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
...
pub async fn update_template(configuration: &configuration::Configuration, template_id: i32, template_definition_new: models::TemplateDefinitionNew) -> Result<models::InlineObject18, Error<UpdateTemplateError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_template_id = template_id;
    let p_template_definition_new = template_definition_new;
