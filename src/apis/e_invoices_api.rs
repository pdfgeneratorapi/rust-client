...
/// struct for typed errors of method [`create_e_invoice`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateEInvoiceError {
...
/// struct for typed errors of method [`create_factur_xe_invoice`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateFacturXeInvoiceError {
    Status401(models::InlineObject21),
    Status402(models::InlineObject22),
    Status403(models::InlineObject23),
    Status404(models::InlineObject24),
...
/// struct for typed errors of method [`create_x_rechnung_e_invoice`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum CreateXRechnungEInvoiceError {
    Status401(models::InlineObject21),
    Status402(models::InlineObject22),
    Status403(models::InlineObject23),
    Status404(models::InlineObject24),
...
/// struct for typed errors of method [`get_e_invoice_schema`]
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(untagged)]
pub enum GetEInvoiceSchemaError {
    Status429(models::InlineObject26),
    Status500(models::InlineObject27),
    UnknownValue(serde_json::Value),
}
...
pub async fn create_e_invoice(configuration: &configuration::Configuration, create_e_invoice_request: models::CreateEInvoiceRequest) -> Result<models::InlineObject, Error<CreateEInvoiceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_create_e_invoice_request = create_e_invoice_request;

    let uri_str = format!("{}/einvoice", configuration.base_path);
    ...
    req_builder = req_builder.json(&p_create_e_invoice_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateEInvoiceError> = serde_json::from_str(&content).ok();
...
pub async fn create_factur_xe_invoice(configuration: &configuration::Configuration, create_factur_xe_invoice_request: models::CreateFacturXeInvoiceRequest) -> Result<models::InlineObject9, Error<CreateFacturXeInvoiceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_create_factur_xe_invoice_request = create_factur_xe_invoice_request;

    let uri_str = format!("{}/einvoice/facturx", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    req_builder = req_builder.json(&p_create_factur_xe_invoice_request);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateFacturXeInvoiceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
...
pub async fn create_x_rechnung_e_invoice(configuration: &configuration::Configuration, create_e_invoice_request: models::CreateEInvoiceRequest) -> Result<models::InlineObject, Error<CreateXRechnungEInvoiceError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_create_e_invoice_request = create_e_invoice_request;

    let uri_str = format!("{}/einvoice/xrechnung", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<CreateXRechnungEInvoiceError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}

/// Returns e-invoice JSON schema which defines the structure of the e-invoice.
pub async fn get_e_invoice_schema(configuration: &configuration::Configuration, ) -> Result<serde_json::Value, Error<GetEInvoiceSchemaError>> {

    let uri_str = format!("{}/einvoice/schema", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        let content = resp.text().await?;
        let entity: Option<GetEInvoiceSchemaError> = serde_json::from_str(&content).ok();
        Err(Error::ResponseError(ResponseContent { status, content, entity }))
    }
}
