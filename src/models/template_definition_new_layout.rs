...
pub struct TemplateDefinitionNewLayout {
    ...
    #[serde(rename = "margins", skip_serializing_if = "Option::is_none")]
    pub margins: Option<Box<models::TemplateDefinitionNewLayoutMargins>>,
    #[serde(rename = "repeatLayout", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub repeat_layout: Option<Option<Box<models::TemplateDefinitionNewLayoutRepeatLayout>>>,
    /// Specifies how many blank lables to add to sheet label.
    #[serde(rename = "emptyLabels", skip_serializing_if = "Option::is_none")]
    pub empty_labels: Option<i32>,
}

impl TemplateDefinitionNewLayout {
    /// Defines template layout (e.g page format, margins).
    pub fn new() -> TemplateDefinitionNewLayout {
