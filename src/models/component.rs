...
pub struct Component {
    ...
    #[serde(rename = "dataIndex", skip_serializing_if = "Option::is_none")]
...
pub enum Cls {
    #[serde(rename = "labelComponent")]
    LabelComponent,
    #[serde(rename = "textComponent")]
    TextComponent,
    #[serde(rename = "dateComponent")]
    DateComponent,
    #[serde(rename = "numberComponent")]
    NumberComponent,
    #[serde(rename = "htmlblockComponent")]
    HtmlblockComponent,
    #[serde(rename = "tableComponent")]
    TableComponent,
    #[serde(rename = "compositeComponent")]
    CompositeComponent,
    #[serde(rename = "chartComponent")]
    ChartComponent,
    #[serde(rename = "barcodeComponent")]
    BarcodeComponent,
    #[serde(rename = "qrcodeComponent")]
    QrcodeComponent,
    #[serde(rename = "imageComponent")]
    ImageComponent,
    #[serde(rename = "headerComponent")]
    HeaderComponent,
    #[serde(rename = "footerComponent")]
    FooterComponent,
    #[serde(rename = "rectangleComponent")]
    RectangleComponent,
    #[serde(rename = "vlineComponent")]
    VlineComponent,
    #[serde(rename = "hlineComponent")]
    HlineComponent,
    #[serde(rename = "pagenumberComponent")]
    PagenumberComponent,
    #[serde(rename = "symbolComponent")]
    SymbolComponent,
    #[serde(rename = "checkboxComponent")]
    CheckboxComponent,
    #[serde(rename = "radioComponent")]
    RadioComponent,
    #[serde(rename = "signatureComponent")]
    SignatureComponent,
}
