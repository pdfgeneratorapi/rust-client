...
pub struct ConvertPdf2ImageRequest {
    /// Base64 encoded PDF file. Required if file_url is not provided.
    #[serde(rename = "file_base64", skip_serializing_if = "Option::is_none")]
...
impl ConvertPdf2ImageRequest {
    pub fn new() -> ConvertPdf2ImageRequest {
